...
import { useModernTetris } from '../hooks/useModernTetris';
        ...
        <div style={{
            ...
            {displayGrid.flat().map((cell, idx) => (
                <div key={idx} style={{
                    ...
                    boxShadow: cell !== 0 && size !== 'mini' ? `0 0 5px ${color}` : 'none',
                    aspectRatio: '1'
                }} />
            ))}
        </div>
...
export const ModernTetris: React.FC<ModernTetrisProps> = ({ 
    onBackToHome, 
    randomizer = '7-bag',
    keyMap, 
    onOpenSettings 
    ...
    const { 
        ...
        holdPiece,
        pieceCounts
    } = useModernTetris(keyMap, randomizer);
    ...
    return (
        <div style={containerStyle}>
            ...
            <div style={{ position: 'relative', width: '450px' }}>
                ...
                {/* Left Hold Box Sidebar (positioned absolutely to the left) */}
                <div style={{
                    position: 'absolute',
                    right: 'calc(100% + 40px)',
                    top: 0,
                ...
                {/* 3. Score Dashboard Panel (positioned absolutely to the right) */}
                <div style={{
                    ...panelStyle,
                    position: 'absolute',
                    left: 'calc(100% + 40px)',
                ...
                {/* 4. Piece Stats Panel (positioned absolutely to the right of score panel) */}
                <div style={{
                    ...panelStyle,
                    position: 'absolute',
